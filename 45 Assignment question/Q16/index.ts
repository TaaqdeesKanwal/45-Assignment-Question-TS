...
let friends=["Abdullah","Taskeen","Saifullah","Rubina"]
let notAttend="Taskeen"//taskeen is not coming
let newGuest = "Samha"//samha is coming in place of taskeen
...
let index = 3
let middleFriend = "Sehar"
friends.splice(index,0,middleFriend)
//This push method add guest in the end
friends.push("Abdul Moiz")
//print invitation
friends.map((item)=>(
    console.log(`Dear ${item} I found an other big dining table for Saturday Dinner`)
))
